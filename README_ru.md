...
![Демонстрация Проекта](./gifs/toList.gif)
...
<details>
  ...
  3. **Логика программирования**, применяемая в реальном контексте.
...
<details>
  ...
  - 🪐 [Планеты Star Wars](https://github.com/SamuelRocha91/javascriptStarWarsPlanets/blob/main/README_ru.md)
